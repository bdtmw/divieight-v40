...
/**
 * BYOK Stripe: all API calls use the project's own STRIPE_SECRET_KEY.
 * The `env` argument is kept for call-site compatibility — the key itself
 * decides whether calls run against test (sk_test_) or live (sk_live_) data.
 */
